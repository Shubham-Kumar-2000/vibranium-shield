...
const timedOut = require('got/source/utils/timed-out');
const getBodySize = require('got/source/utils/get-body-size');
const getResponse = require('got/source/get-response');
const progress = require('got/source/progress');
const {CacheError, UnsupportedProtocolError, MaxRedirectsError, RequestError, TimeoutError} = require('got/source/errors');
const urlToOptions = require('got/source/utils/url-to-options');
